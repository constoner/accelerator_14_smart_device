...
/* harmony import */ var _utils_ios_checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/ios-checker */ "./js/utils/ios-checker.js");
...
/* harmony import */ var _modules_sticky_header_sticky_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/sticky-header/sticky-header */ "./js/modules/sticky-header/sticky-header.js");
/* harmony import */ var _utils_focus_visible_polyfill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/focus-visible-polyfill */ "./js/utils/focus-visible-polyfill.js");
/* harmony import */ var _utils_focus_visible_polyfill__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_utils_focus_visible_polyfill__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _utils_focus_lock__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/focus-lock */ "./js/utils/focus-lock.js");
/* harmony import */ var _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/scroll-lock */ "./js/utils/scroll-lock.js");
/* harmony import */ var _utils_smooth_scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/smooth-scroll */ "./js/utils/smooth-scroll.js");
/* harmony import */ var _modules_spoiler_spoiler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/spoiler/spoiler */ "./js/modules/spoiler/spoiler.js");
/* harmony import */ var _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/modals/init-modals */ "./js/modules/modals/init-modals.js");
/* harmony import */ var _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/form-validate/form */ "./js/modules/form-validate/form.js");
/* harmony import */ var _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_smooth_scroll__WEBPACK_IMPORTED_MODULE_6__["smoothScroll"])();
  Object(_modules_spoiler_spoiler__WEBPACK_IMPORTED_MODULE_7__["initSpoiler"])();

  // Modules
  // ---------------------------------
  Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_10__["initAccordions"])();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    var stickyHeader = new _modules_sticky_header_sticky_header__WEBPACK_IMPORTED_MODULE_2__["StickyHeader"]();
    stickyHeader.init();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_8__["initModals"])();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_9__["Form"]();
    window.form = form;
    form.init();
  });
});
...
/***/ "./js/modules/spoiler/spoiler.js":
/*!***************************************!*\
  !*** ./js/modules/spoiler/spoiler.js ***!
  \***************************************/
/*! exports provided: initSpoiler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSpoiler", function() { return initSpoiler; });
function initSpoiler() {
  var spoilerContainer = document.querySelector('[data-spoiler="container"]');
  var spoilerButton = document.querySelector('[data-spoiler="button"]');
  var toggleSpoiler = function toggleSpoiler() {
...
/***/ "./js/modules/sticky-header/sticky-header.js":
/*!***************************************************!*\
  !*** ./js/modules/sticky-header/sticky-header.js ***!
  \***************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "smoothScroll", function() { return o; });
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
/* eslint-disable */
function o() {
  var o = window;
  ...
  function f(o) {
    if (o === null || _typeof(o) !== 'object' || void 0 === o.behavior || o.behavior === 'auto' || o.behavior === 'instant') {
      return !0;
    }
    if (_typeof(o) === 'object' && o.behavior === 'smooth') {
      return !1;
    }
